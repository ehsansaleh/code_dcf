...
# Usage: ./download.sh [tiered or cifar]
# note:  This file downloads the datasets from the google drive.
#        It only downloads CUB and miniImagenet by default.
...
#        download and untar the files yourself. The same goes for the cifar-fs
#        dataset; if you need it run ./download.sh cifar
